...
# 方案1 抓取网络内容
url="http://book.sciencereading.cn/shop/book/Booksimple/list.do?showQueryModel.nameIsbnAuthor=%E7%94%9F%E6%80%81%E7%B3%BB%E7%BB%9F&pageSplit.showRow=50"
...
for index in range(0,mylen):         #(1,mylen) 分别是开始位置和循环次数的参数
    ...
    while (page<600):
        ...
        print(download)
        r = requests.get(download,headers=headers,timeout= 100)
